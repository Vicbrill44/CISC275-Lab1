...
const yourName : String = "Victor Vasquez";
let yourPronouns : String = "I'm Okay with anything";
const yourMajor : String = "Computer Science";
let classification : String = "Junior";
let oneExcite : String = "Learning about the workflow of a software engineer";
let anyConcerns : String = "Not really";
let funFact : String = "I really like futbol";
